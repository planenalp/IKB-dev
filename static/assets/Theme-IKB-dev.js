...
document.addEventListener('DOMContentLoaded', function() {    
    ...
    // ==================== 随机背景图（如 root 内使用固定图片可禁用这段） START ====================
    ...
    /* 通用默认亮主题配色 */
    :root {
        /* --bgURL: url("https://dev.klein.blue/bg/bgLight.webp"); */ /* 定义单个地址 */
        /* --bgURL: url("https://dev.klein.blue/bg/bgLight.webp"), url("https://planenalp.github.io/IKB-dev/bg/bgLight.webp"); */ /* 定义主地址和备选地址 */
        /* avatar-blue.svg */
    ...
    [data-color-mode=dark][data-dark-theme=dark]::selection {
        /* --bgURL: url("https://dev.klein.blue/bg/bgDark.webp"); */ /* 定义单个地址 */
        /* --bgURL: url("https://dev.klein.blue/bg/bgDark.webp"), url("https://planenalp.github.io/IKB-dev/bg/bgDark.webp"); */ /* 定义主地址和备选地址 */
