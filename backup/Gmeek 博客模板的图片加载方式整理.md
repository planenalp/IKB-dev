...
因为 GitHub Issues 有最大字符限制，而且两种 base64 实现方式都没法使用 MarkDown 的引用语法，所以研究 base64 没意义

下面仅作记录示例


# 1. GitHub Pages upload（推荐常规使用）
...
# 2. Gmeek + Fancybox（推荐偶然用 base64 时使用）
...
```
`Gmeek-html<img data-fancybox="gallery" img src="https://github.com/user-attachments/assets/918d11b9-5864-429e-b7fe-1dffcb08a309">`


# 3. GJken 代码（可在需要 base64 时使用，但没太大意义）
...
# 4. Gmeek 自带格式（复杂情况使用）
优点：支持 HTML 语法，如 ``Gmeek-html<img src="URL" alt="name" width="100%">``
